  ...
  return (
    <SectionWrapper id="process">
      <div className="flex flex-col gap-10 md:gap-12">
        ...
        />
        <ol className="grid md:grid-cols-4 gap-3 md:gap-4" aria-label="Project process">
          {BUILD_PROCESS.map((phase, idx) => (
            <li
              key={phase.step}
              className="rounded-xl border border-border bg-card p-4 md:p-5 flex flex-col gap-2"
            >
